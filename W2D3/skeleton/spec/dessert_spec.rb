...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      dessert.add_ingredient("choco chips")
      expect(dessert.ingredients).to include("choco chips")
    end
  end

  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["choco chips", "dough", "milk", "eggs", "sugar", "butter"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef Mom the Great Baker has made 50 cookies!")
    end
  end
